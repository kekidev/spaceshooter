...
export function wasm_bindgen__convert__closures__invoke0_mut__h367c201d9048e6f5(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h021caf09f6a04762(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h764cb4a71a0b6cc0(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h046ebb05a3714bc9(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hf04f0af7c2efca20(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h42ace7d6d2a28aba(a: number, b: number): void;
